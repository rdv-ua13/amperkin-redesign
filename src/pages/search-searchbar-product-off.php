		...
		<div class="gap-xl">
            <div class="gap-lg">
                <div class="product-out-stock">
                    <div class="product-out-stock-sidebar">
                        <div class="product-out-stock-sidebar__title h3">Этот товар закончился</div>
                        <div class="product-out-stock-sidebar__desired">
                            <div class="product-out-stock-sidebar__desired-view">
                                <picture>
                            ...
                            <div class="product-out-stock-sidebar__desired-descr">
                                <div class="product-out-stock-sidebar__desired-descr-title">Haupa Набор инструментов HAUPA VDE «Tool belt»</div>
                                <div class="product-availability out-stock">
                                    <svg class="icon">
                    ...
                    <div class="product-out-stock-suggest">
            ...
            <div class="gap-md border-bottom extra-search-wrapper">
                <div class="">
								...
								<ul class="list-reset catalog-sidebar-filter__options">
									<li class="catalog-sidebar-filter__options-item">
										...
										<span class="custom-checkbox">
											<input id="csf-checkbox-1" class="custom-checkbox__input" type="checkbox">
											<label for="csf-checkbox-1" class="custom-checkbox__label-for">Новинки</label>
										</span>
											</li>
											<li class="catalog-sidebar-filter__item">
										<span class="custom-checkbox">
											<input id="csf-checkbox-2" class="custom-checkbox__input" type="checkbox">
											<label for="csf-checkbox-2" class="custom-checkbox__label-for">Акции</label>
										</span>
											</li>
											<li class="catalog-sidebar-filter__item">
										<span class="custom-checkbox">
											<input id="csf-checkbox-3" class="custom-checkbox__input" type="checkbox">
												...
												<div class="spoiler" data-spoiler>
													<div class="spoiler-content">
														<ul class="list-reset catalog-sidebar-filter__list collapse-content-in" data-filter-option-content>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-10" class="custom-checkbox__input" type="checkbox">
															<label for="csf-checkbox-10" class="custom-checkbox__label-for">USB розетки</label>
														</span>
															</li>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-11" class="custom-checkbox__input" type="checkbox">
															<label for="csf-checkbox-11" class="custom-checkbox__label-for">Антенные розетки</label>
														</span>
															</li>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-12" class="custom-checkbox__input" type="checkbox" disabled>
															<label for="csf-checkbox-12" class="custom-checkbox__label-for">Блоки розеток и выключателей</label>
														</span>
															</li>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-13" class="custom-checkbox__input disabled" type="checkbox">
															<label for="csf-checkbox-13" class="custom-checkbox__label-for">Выключатели</label>
														</span>
															</li>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-14" class="custom-checkbox__input" type="checkbox">
															<label for="csf-checkbox-14" class="custom-checkbox__label-for">Выключатели с ДУ</label>
														</span>
															</li>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-15" class="custom-checkbox__input" type="checkbox">
												...
												<div class="spoiler" data-spoiler>
													<div class="spoiler-content">
														<ul class="list-reset catalog-sidebar-filter__list collapse-content-in" data-filter-option-content>
															<li class="catalog-sidebar-filter__item">
														<span class="custom-checkbox">
															<input id="csf-checkbox-90" class="custom-checkbox__input" type="checkbox" checked>
