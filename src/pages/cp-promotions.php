...
<div class="gap-xl">
	<div class="container">
		<div class="gap-xl content-page best-offer">
            <div class="gap-xs">
            ...
            <div class="gap-md">
                <div class="catalog-heading">
                    <div class="h1 catalog-heading__title">Действующие акции</div>
                </div>
            </div>
            <div class="gap-lg content-wrapper-mobile-section">
                <div class="content-wrapper-mobile-section-container">
                    <div class="best-offer-stand">
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-3.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-3.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-4.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-4.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-5.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-5.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-6.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-6.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-7.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-7.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-8.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-8.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-9.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-9.png"
                                    class="image"
                        ...
                        <a class="best-offer-stand__item" href="javascript:;">
                            <picture>
                                <source srcset="img/promo-10.webp" type="image/webp">
                                <img
                                    loading="lazy"
                                    src="img/promo-10.png"
                                    class="image"
                                    width="630"
                                    height="305"
                                    alt="Изображение блока"
            ...
            <div class="gap-xl">
                <div class="basic-banner">
                    <div class="basic-banner__text">
                        <div class="basic-banner__title h3">Кэшбэк 15% на серию Glossa<br> от System Electric</div>
                        <div class="basic-banner__subtitle">Выгодные условия в декабре 2022 года для всех покупателей</div>
                    </div>
                    <div class="basic-banner__decor">
                        <img
                                loading="lazy"
